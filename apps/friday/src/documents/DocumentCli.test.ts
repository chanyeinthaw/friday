...
const documentStubs = {
  ...
  addSlackConnection: unreachable,
  updateSlackConnection: unreachable,
  removeSlackConnection: unreachable,
  enableSlackConnection: unreachable,
  disableSlackConnection: unreachable,
  getSlackConnection: unreachable,
  listSlackConnections: unreachable,
  setSlackAccess: unreachable,
  setSlackChannel: unreachable,
  resetSlackChannel: unreachable,
