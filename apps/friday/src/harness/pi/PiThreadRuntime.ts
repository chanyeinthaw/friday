...
const makeSession = Effect.fn('makePiAgentSession')(function* (
  ...
  const fridaySkillPaths = fridaySkillPathsForAudience(options.thread.audience)
  if (fridaySkillPaths.length > 0) {
    resourceLoaderOptions.additionalSkillPaths = [...fridaySkillPaths]
  }
